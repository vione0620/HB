 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `CAYYModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         YYBook *book = [YYBook cayy_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book cayy_modelToJSONString];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self cayy_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self cayy_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self cayy_modelCopy]; }
     - (NSUInteger)hash { return [self cayy_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self cayy_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (CACAYYModel)
 ...
 */
+ (nullable instancetype)cayy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)cayy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)cayy_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)cayy_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)cayy_modelToJSONObject;
 ...
 */
- (nullable NSData *)cayy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)cayy_modelToJSONString;
 ...
 */
- (void)cayy_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)cayy_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)cayy_modelIsEqual:(id)model;
 ...
 */
- (NSString *)cayy_modelCADescription;
 ...
 */
+ (nullable NSArray *)cayy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (CAYYModel)
 ...
 */
+ (nullable NSDictionary *)cayy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<CAYYModel>' to your class header.
 */
@protocol CAYYModel <NSObject>
@optional
