...
@class CAEasyWaterfallLayout;

@protocol CAEasyWaterfallLayoutDelegate <NSObject>

@required
///计算item高度的代理方法，将item的高度与indexPath传递给外界
- (CGFloat)waterfallLayout:(CAEasyWaterfallLayout *)waterfallLayout itemHeightForWidth:(CGFloat)itemWidth atIndexPath:(NSIndexPath *)indexPath;
...
@interface CAEasyWaterfallLayout : UICollectionViewLayout
#pragma mark- 属性
///总共多少列，默认是2
...
///代理，用来计算item的高度
@property (nonatomic, weak) id<CAEasyWaterfallLayoutDelegate> delegate;
